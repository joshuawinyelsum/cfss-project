...
with open('frontend/src/app/dashboard/work/submitted/page.tsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('frontend/src/app/dashboard/work/submitted/page.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated submitted page")
