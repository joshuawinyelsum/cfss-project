...
# Find the start of navItems and replace everything until the end
start_idx = content.find("  const navItems = [")
if start_idx == -1:
    print("Could not find navItems!")
    exit(1)
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-gray-200 shrink-0 z-10">
        ...
        <div className="p-4 mt-auto border-t border-gray-100">
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 mb-4">
            ...
            <button 
              className={w-full py-2 bg-white hover:bg-gray-50 border border-gray-200 rounded-lg text-xs font-medium text-gray-700 transition-colors flex items-center justify-center gap-2 }
              onClick={() => {
